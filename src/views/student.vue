      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <span>{{scope.row.create_time|timefmt}}</span>
          </template>
        </el-table-column>
        <el-table-column
          prop="sex_type"
        ...
        <el-table-column
          label="班级类别">
          <template slot-scope="scope">
            <span>{{gradeItems[scope.row.grade]}}</span>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods:{
    async getUserList(pageNum){
      ...
      let res = await userApi.getUserList("student",{
    ...
    addUsers(){
      ...
      self.$refs.ruleForm.validate(async (valid) => {
        if (valid) {
          ...
          console.log(data);
          let res = await userApi.addUser("student",data);
          console.log(res);
          if(res.success){
